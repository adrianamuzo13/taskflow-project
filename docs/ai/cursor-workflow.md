...
- ctrl + L -> para abrir el chat. Uso de chat contextual con @Files para entender la lógica del proyecto sin salir del editor.
...
Le pedí a composer que creara `utils.js` para la funciones de estrellas los `import` en app.js 
